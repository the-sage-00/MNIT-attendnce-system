...
4. **Start a Session**:
   ...
   > ⚠️ **IMPORTANT FOR EVALUATORS**: Use a **mobile phone** to start sessions! Laptops/PCs use IP-based geolocation which is inaccurate (often ±1-10km off). Mobile phones have real GPS hardware for precise location.
